...
/// Start the Chameleon Mecha game server on the given port.
Future<HttpServer> startServer({int? port}) async {
  final serverPort = port ?? GameConstants.serverPort;
  ...
  print('🦎 Chameleon Mecha Server running on port $serverPort');
...
void _listenToServer(HttpServer server) async {
